...
import com.project.wangyuming.core.function.VoidNoParamsFunction;
...
public class PrintUtil {
    ...
    public static void template(String title, VoidNoParamsFunction contentAction) {
        ...
        com.project.wangyuming.core.util.PrintUtil.printlnLine();
        com.project.wangyuming.core.util.PrintUtil.println(StringUtil.nullToEmpty(title));
